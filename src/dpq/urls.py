...
urlpatterns = patterns('',
                       ...
                       (r'^retro/(?P<sprint>[0-9]{1,3})/(?P<team>[a-zA-Z]{1,32})/$', retro_boards_sprint),
                       (r'^retro/browse/$', retro_browse_points),
                       ...
                       (r'^api/retro/(?P<sprint>[0-9]{1,3})/(?P<team>[a-zA-Z]{1,32})/$', retro_board_table_contents),
                       ...
                       (r'^api/retro/sticker/change_status/$', change_action_point_status),
                       (r'^login/$', login),
                       (r'^api/ci/sync/$', ci_sync_desk_check_data),
