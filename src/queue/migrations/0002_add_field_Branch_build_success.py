...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.build_success'
        db.add_column('queue_branch', 'build_success',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.build_success'
        db.delete_column('queue_branch', 'build_success')
