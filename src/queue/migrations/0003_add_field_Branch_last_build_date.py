...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.last_build_date'
        db.add_column('queue_branch', 'last_build_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.last_build_date'
        db.delete_column('queue_branch', 'last_build_date')
