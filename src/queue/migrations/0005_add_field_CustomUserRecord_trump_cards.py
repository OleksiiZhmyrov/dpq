...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUserRecord.trump_cards'
        db.add_column('queue_customuserrecord', 'trump_cards',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUserRecord.trump_cards'
        db.delete_column('queue_customuserrecord', 'trump_cards')
