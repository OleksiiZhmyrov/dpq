...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.team'
        db.add_column('queue_queue', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.Team'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Queue.team'
        db.delete_column('queue_queue', 'team_id')
