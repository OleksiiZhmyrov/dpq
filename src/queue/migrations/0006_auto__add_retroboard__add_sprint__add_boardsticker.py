...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RetroBoard'
        db.create_table('queue_retroboard', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sprint', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.Sprint'])),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.Team'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.CustomUserRecord'])),
            ('vote_limit', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('queue', ['RetroBoard'])

        # Adding model 'Sprint'
        db.create_table('queue_sprint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('motto', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('finish_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('queue', ['Sprint'])

        # Adding model 'BoardSticker'
        db.create_table('queue_boardsticker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.CustomUserRecord'])),
            ('retroBoard', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.RetroBoard'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modification_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('is_modified', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('summary', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('voters', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='C', max_length=1)),
        ))
        db.send_create_signal('queue', ['BoardSticker'])


    def backwards(self, orm):
        # Deleting model 'RetroBoard'
        db.delete_table('queue_retroboard')

        # Deleting model 'Sprint'
        db.delete_table('queue_sprint')

        # Deleting model 'BoardSticker'
        db.delete_table('queue_boardsticker')
