...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserToRetroBoardConnector'
        db.create_table('queue_usertoretroboardconnector', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('custom_user_record', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.CustomUserRecord'])),
            ('retroBoard', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queue.RetroBoard'])),
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('queue', ['UserToRetroBoardConnector'])


        # Changing field 'BoardSticker.summary'
        db.alter_column('queue_boardsticker', 'summary', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):
        # Deleting model 'UserToRetroBoardConnector'
        db.delete_table('queue_usertoretroboardconnector')


        # Changing field 'BoardSticker.summary'
        db.alter_column('queue_boardsticker', 'summary', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
