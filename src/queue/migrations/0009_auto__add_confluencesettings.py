...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConfluenceSettings'
        db.create_table('queue_confluencesettings', (
            ...
            ('namespace', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('page_title', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        db.send_create_signal('queue', ['ConfluenceSettings'])


    def backwards(self, orm):
        # Deleting model 'ConfluenceSettings'
        db.delete_table('queue_confluencesettings')
