...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeskCheckStatistic'
        db.create_table('queue_deskcheckstatistic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('total_count', self.gf('django.db.models.fields.FloatField')()),
            ('total_count_sp', self.gf('django.db.models.fields.FloatField')()),
            ('other_count', self.gf('django.db.models.fields.FloatField')()),
            ('other_count_sp', self.gf('django.db.models.fields.FloatField')()),
            ('other_percent', self.gf('django.db.models.fields.FloatField')()),
            ('other_percent_sp', self.gf('django.db.models.fields.FloatField')()),
            ('passed_count', self.gf('django.db.models.fields.FloatField')()),
            ('passed_count_sp', self.gf('django.db.models.fields.FloatField')()),
            ('passed_percent', self.gf('django.db.models.fields.FloatField')()),
            ('passed_percent_sp', self.gf('django.db.models.fields.FloatField')()),
            ('ready_count', self.gf('django.db.models.fields.FloatField')()),
            ('ready_count_sp', self.gf('django.db.models.fields.FloatField')()),
            ('ready_percent', self.gf('django.db.models.fields.FloatField')()),
            ('ready_percent_sp', self.gf('django.db.models.fields.FloatField')()),
            ('failed_count', self.gf('django.db.models.fields.FloatField')()),
            ('failed_count_sp', self.gf('django.db.models.fields.FloatField')()),
            ('failed_percent', self.gf('django.db.models.fields.FloatField')()),
            ('failed_percent_sp', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('queue', ['DeskCheckStatistic'])


    def backwards(self, orm):
        # Deleting model 'DeskCheckStatistic'
        db.delete_table('queue_deskcheckstatistic')
