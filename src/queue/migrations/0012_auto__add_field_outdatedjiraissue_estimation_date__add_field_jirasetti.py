...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OutdatedJiraIssue.estimation_date'
        db.add_column(u'queue_outdatedjiraissue', 'estimation_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'JiraSettings.custom_field_story_points'
        db.add_column(u'queue_jirasettings', 'custom_field_story_points',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True),
                      keep_default=False)

        # Adding field 'JiraSettings.custom_field_epic_name'
        db.add_column(u'queue_jirasettings', 'custom_field_epic_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True),
                      keep_default=False)

        # Adding field 'JiraSettings.custom_field_tester'
        db.add_column(u'queue_jirasettings', 'custom_field_tester',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True),
                      keep_default=False)

        # Adding field 'JiraSettings.custom_field_team'
        db.add_column(u'queue_jirasettings', 'custom_field_team',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True),
                      keep_default=False)

        # Adding field 'JiraSettings.custom_field_estimation_date'
        db.add_column(u'queue_jirasettings', 'custom_field_estimation_date',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OutdatedJiraIssue.estimation_date'
        db.delete_column(u'queue_outdatedjiraissue', 'estimation_date')

        # Deleting field 'JiraSettings.custom_field_story_points'
        db.delete_column(u'queue_jirasettings', 'custom_field_story_points')

        # Deleting field 'JiraSettings.custom_field_epic_name'
        db.delete_column(u'queue_jirasettings', 'custom_field_epic_name')

        # Deleting field 'JiraSettings.custom_field_tester'
        db.delete_column(u'queue_jirasettings', 'custom_field_tester')

        # Deleting field 'JiraSettings.custom_field_team'
        db.delete_column(u'queue_jirasettings', 'custom_field_team')

        # Deleting field 'JiraSettings.custom_field_estimation_date'
        db.delete_column(u'queue_jirasettings', 'custom_field_estimation_date')
    ...
    models = {
        ...
        u'queue.jirasettings': {
            ...
            'custom_field_epic_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'null': 'True'}),
            'custom_field_estimation_date': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'null': 'True'}),
            'custom_field_story_points': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'null': 'True'}),
            'custom_field_team': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'null': 'True'}),
            'custom_field_tester': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        u'queue.outdatedjiraissue': {
            ...
            'estimation_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
