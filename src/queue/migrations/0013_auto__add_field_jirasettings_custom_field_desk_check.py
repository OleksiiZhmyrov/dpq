...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JiraSettings.custom_field_desk_check'
        db.add_column(u'queue_jirasettings', 'custom_field_desk_check',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JiraSettings.custom_field_desk_check'
        db.delete_column(u'queue_jirasettings', 'custom_field_desk_check')
