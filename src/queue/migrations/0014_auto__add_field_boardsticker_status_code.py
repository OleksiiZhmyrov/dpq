...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BoardSticker.status_code'
        db.add_column(u'queue_boardsticker', 'status_code',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BoardSticker.status_code'
        db.delete_column(u'queue_boardsticker', 'status_code')
