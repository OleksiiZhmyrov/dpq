...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConfluenceSettings.SvG_page_title'
        db.add_column(u'queue_confluencesettings', 'SvG_page_title',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConfluenceSettings.SvG_page_title'
        db.delete_column(u'queue_confluencesettings', 'SvG_page_title')
