...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConfluenceSettings.page_title'
        db.delete_column(u'queue_confluencesettings', 'page_title')

        # Adding field 'JiraSettings.custom_field_onshore_ba'
        db.add_column('queue_jirasettings', 'custom_field_onshore_ba',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ConfluenceSettings.page_title'
        db.add_column(u'queue_confluencesettings', 'page_title',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'JiraSettings.custom_field_onshore_ba'
        db.delete_column('queue_jirasettings', 'custom_field_onshore_ba')
    ...
    models = {
        ...
        'queue.boardsticker': {
            ...
            'status_code': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        'queue.confluencesettings': {
            'Meta': {'object_name': 'ConfluenceSettings'},
            'SvG_page_title': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'queue.jirasettings': {
            ...
            'custom_field_desk_check': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'null': 'True'}),
            ...
            'custom_field_onshore_ba': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'null': 'True'}),
